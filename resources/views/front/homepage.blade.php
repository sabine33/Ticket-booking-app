...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Hawaijahaj Online Flight Reservation and Sceduling System</title>
                        ...
                        <div class="nav-right">
                            <div class="flex-center position-ref full-height">
                                <div class="top-right links">
                                    <a href="http://127.0.0.1:8000/login" class="primary-btn">Login</a>

                                    <a href="http://127.0.0.1:8000/register" class="primary-btn">Register</a>
                                </div>
