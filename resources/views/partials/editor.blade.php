  <ul class="list-inline my-1 d-flex">
      ...
      <li class="list-inline-item">
          <button class="btn btn-danger btn-sm rounded-0 btn-delete" id="delete_button_{{$id}}" data-id="{{$id}}" data-model="{{$model}}" type="button" data-toggle="modal" data-target="#deleteModal" data-placement="top" title="Delete"><i class="fa fa-trash"></i></button>
      </li>
  </ul>